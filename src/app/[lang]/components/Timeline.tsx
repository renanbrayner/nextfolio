    ...
    if (side === "left") {
      return (
        <div className="group flex flex-row-reverse md:contents">
          <div className="col-start-1 col-end-5 my-4 ml-auto flex flex-col rounded-xl border border-slate-700/50 bg-slate-900/50 p-4 shadow-md transition-all group-hover:scale-105 group-hover:shadow-xl">
    ...
    if (side === "right") {
      return (
        <div className="group flex md:contents">
          ...
          <div className="col-start-6 col-end-10 my-4 mr-auto flex flex-col rounded-xl border border-slate-700/50 bg-slate-900/50 p-4 shadow-md  transition-all group-hover:scale-105 group-hover:shadow-xl">
            <h3 className="mb-1 text-lg font-semibold">{title}</h3>
            <p className="text-justify leading-tight">{children}</p>
            <span className="ml-auto flex items-center gap-1 pt-2">
              <FiCalendar /> {date}
